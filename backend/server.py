...
loaded_model = tf.keras.models.load_model("./Medical-Report-Generator/backend/accumodelpp84.h5")
...
model = load_model('./Medical-Report-Generator/backend/indianamodel.keras')


# Load necessary pre-processing objects (wordtoix, ixtoword, max_length)
with open('./Medical-Report-Generator/backend/ixtoword1.json', 'r') as f:
    ixtoword = json.load(f)

with open('./Medical-Report-Generator/backend/wordtoix1.json', 'r') as f:
